        ...
        FirebaseDatabase.getInstance().getReference().child("Requests").child(preferencesClass.get_USERFOR()).child(FirebaseAuth.getInstance().getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    getdoctorordriverslist.add(new getdoctorordriver(snapshot.child("client_name").getValue().toString(),snapshot.child("image").getValue().toString(),snapshot.child("address").getValue().toString(),"",snapshot.child("latlng").getValue().toString(),"",snapshot.getKey(),snapshot.child("status").getValue().toString()));
            ...
            public void onClick(View v) {
                ...
                FirebaseDatabase.getInstance()
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        getpatientid = dataSnapshot.child("patient").getValue().toString();
                        FirebaseDatabase.getInstance()
                                .getReference("customerRequest")
                                .child(getpatientid).removeValue();
